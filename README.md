...
1. Las variables deben existir previamente en Storyline.
2. Los nombres deben coincidir exactamente (case sensitive).
3. La plataforma debe estar configurada para escuchar eventos `postMessage`.
4. El curso debe exportarse en formato SCORM.
